...
SELECT COUNT(DISTINCT ca.member_id) * 100.0 / COUNT(DISTINCT m.member_id) AS percentage_attended -- Multiply by 100.0 instead of 100 to not round down percentage to an integer
FROM members m 
